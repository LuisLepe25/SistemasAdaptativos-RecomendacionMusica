...
$(document).ready(function () {
    (function() {
        var formulario = document.getElementById("form1");//document.formulario_registro,
        ...
        var opciones = document.getElementsByName('logistica'),
            resultado = false;

        for (var i = 0; i < elementos.length; i++) {
            if (elementos[i].type == "radio" && elementos[i].name == "logistica") {
            ...
            if (resultado == false) {
                ...
                console.log('El campo logistica esta incompleto');
                return false;
            } else {
